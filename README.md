...
I saw that there are some duplicate data in there (duplicate as ad_id + metrics_date combination). For this I created a \_unique_data_id hash value of these 2 columns.
